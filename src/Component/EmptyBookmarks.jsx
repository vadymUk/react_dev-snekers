...
export default function EmptyBookmarks() {
    const { counting } = useContext(CartContext);
    return (
        <>
                ...
                <div className='order__container'>
                    <div className='order__wrapper'>
                        ...
                        <h2 className='order__title'>
                            У вас не має закладок :(
                        </h2>
                        <p className='order__descr'>Ви нічого не добавили</p>
                        <Link to='/'>
                            <button className='order__btn'>На головну</button>
                        </Link>
                    </div>
                </div>
            </div>
